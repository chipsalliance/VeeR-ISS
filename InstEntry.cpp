...
InstTable::setupInstVec()
{
  ...
  instVec_ =
	...
	OperandType::Imm, OperandMode::None, shamtMask },
      ...
      { "slow", InstId::slow, 0x2000103b, top7Funct3Low7Mask,
	InstType::Zbp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::IntReg, OperandMode::Read, rs2Mask },

      { "srow", InstId::srow, 0x2000503b, top7Funct3Low7Mask,
	InstType::Zbp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::IntReg, OperandMode::Read, rs2Mask },

      { "sloiw", InstId::sloiw, 0x2000101b, 0xf800707f,
	InstType::Zbp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::Imm, OperandMode::None, shamtMask },

      { "sroiw", InstId::sroiw, 0x2000501b, 0xf800707f,
	InstType::Zbp,
	OperandType::IntReg, OperandMode::Write, rdMask,
	OperandType::IntReg, OperandMode::Read, rs1Mask,
	OperandType::Imm, OperandMode::None, shamtMask },
